...
function convertirANegativo(evt) {
    var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
    imagenSal.imageArray2DtoDataWithResizing(pantalla2, MathImg_js_1.MathImg.toNegative(imagenSal));
}
...
function desfaseY(evt) {
    ...
    var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
    imagenSal.imageArray2DtoData(pantalla2, MathImg_js_1.MathImg.toDesfaceX(imagenSal, desy));
}
...
function multiplicacion(evt) {
    ...
    var valor = parseFloat(argss);
    var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
    imagenSal.imageArray2DtoData(pantalla2, MathImg_js_1.MathImg.toMultiplication(imagenSal, valor));
}
function subtract(evt) {
    var argss = prompt('Ingresa un numero real');
    var restar = parseFloat(argss);
    var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
    imagenSal.imageArray2DtoData(pantalla2, MathImg_js_1.MathImg.toSubtract(imagenSal, restar));
}
...
function div(evt) {
    ...
    if (dividir == 0) {
        ...
        var dividir = parseFloat(argss);
        var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
        imagenSal.imageArray2DtoData(pantalla2, MathImg_js_1.MathImg.toDividir(imagenSal, dividir));
    }
    else {
        var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
        imagenSal.imageArray2DtoData(pantalla2, MathImg_js_1.MathImg.toDividir(imagenSal, dividir));
...
function generarRampaX(evt) {
    var imagenSal = new ImageType_js_1.ImageType(pantalla1, imgLocal.getImage());
    imagenSal.imageArray2DtoDataWithResizing(pantalla2, MathImg_js_1.MathImg.rampaX(imgLocal.getImage().width, imgLocal.getImage().height));
}
